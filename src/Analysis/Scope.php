...
class Scope
{
    ...
    protected ClassLikeResult|MethodResult|null $result = null;
    ...
    public function attachResult(ClassLikeResult|MethodResult $result): void
    {
        $this->result = $result;
    }

    public function result(): ClassLikeResult|MethodResult|null
    {
        return $this->result;
    }
